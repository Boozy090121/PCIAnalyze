 ...
 * 
 * This component provides the predictive analytics tab for the pharmaceutical
 * process analytics dashboard, displaying forecasts and predictions.
 */
  ...
  if (!filteredData || !schema) {
    return (
      <div className="dashboard-placeholder">
        <h2>Upload an Excel file to view predictive analytics</h2>
